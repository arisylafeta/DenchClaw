...
export const targetAccountListBuilder = defineSkillTemplate({
  ...
  category: "Find Leads",
  outcome: "Discovers target companies, enriches contacts, scores fit, and writes a prioritized list into ReBattery CRM.",
  userUseCase: "Use this when a founder or seller knows the market they want to attack but needs ReBattery to turn that ICP into a clean, ranked account list with evidence, exclusions, owners, and CRM-ready next actions.",
  ...
  skillInstructions: [
    ...
    "Use HubSpot/ReBattery CRM, native enrichment, web search, uploaded files, LinkedIn context, Gmail history, and workspace context to assemble candidate accounts.",
    "Deduplicate against existing HubSpot/ReBattery CRM accounts, customers, active opportunities, Gmail history, previous ReBattery runs, and user-provided exclusions.",
