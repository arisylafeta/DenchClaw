...
const canonicalFields: Record<string, Record<string, CanonicalField>> = {
  people: {
    ...
    "Buying Role": { table: "crm_people", column: "buying_role" },
    Tags: { table: "crm_people", column: "tags" },
    Notes: { table: "crm_people", column: "notes" },
    "User Type": { table: "crm_people", column: "user_type" },
    "User Sub Type": { table: "crm_people", column: "user_sub_type" },
    "Number Times Contacted": { table: "crm_people", column: "number_times_contacted" },
  },
  company: {
    ...
    "Contact Person": { table: "crm_companies", column: "contact_person" },
    "Contact Person Title": { table: "crm_companies", column: "contact_person_title" },
    ...
    "Buyer Exclusion Reason": { table: "crm_companies", column: "buyer_exclusion_reason" },
