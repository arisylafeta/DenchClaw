 ...
 *
 * Exposes the curated DenchClaw CRM DB tool layer over stdio.
 * Third-party app discovery and execution are handled by the official Composio CLI,
 * not by this MCP server.
 *
 * CRM DB layer:
...
export function startServer() {
  console.error("[denchclaw-mcp] Starting CRM MCP server.");
